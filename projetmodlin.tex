...
L'intervalle de confiance est lui bien plus étroit, étant compris entre 5.95 et 7.20. On voit ici assez clairement la différence entre les deux. La différence entre les deux bornes est de 3.43 pour l'intervalle de prédiction et de 1.07 pour l'intervalle de confiance.
